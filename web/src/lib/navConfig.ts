...
export const NAV_REGISTRY: NavRegistryEntry[] = [
  ...
  { key: "stages",      label: "Stage pipelines",  icon: "workflow",  hash: "#/settings/stages",    adminOnly: true, description: "Your stage backbones — each pipeline's stages, order, parallels and target days. Task flows are built on these." },
  ...
  { key: "work-streams", label: "Task flows", icon: "layers",  hash: "#/settings/work-streams", adminOnly: true, description: "Add the modules, tasks and teams for a pipeline's stages. Multiple task flows per pipeline." },
...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { key: "workstream", label: "Task flow" },
