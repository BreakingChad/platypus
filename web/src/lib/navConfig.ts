...
export const NAV_REGISTRY: NavRegistryEntry[] = [
  ...
  { key: "inbox",    label: "Inbox",      icon: "inbox",    hash: "#/inbox",           description: "Tasks routed to you (coming)." },
...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  {
    ...
    defaultLayout: [
      ...
      { id: "blk-my-studies", block: "my-studies" },
      { id: "blk-at-risk-studies", block: "at-risk-studies" },
      { id: "blk-workload", block: "workload" },
      ...
      { id: "blk-cycle-time", block: "cycle-time" },
      { id: "blk-setup-hub", block: "setup-hub" },
      { id: "blk-work-tiles", block: "work-tiles" },
    ],
  },
];
